...
$pdf->cell(70,8,'',0);
$pdf->cell(100,8,'LOST AND FOUND PERSONS REPORT',0);
$pdf->Ln(15);
...
$missing=mysqli_query($conn,"SELECT * FROM lostandfound WHERE (`Date_Reported` BETWEEN '".$startdate."' AND '".$enddate."') ORDER BY Full_Name");
$sno=0;
